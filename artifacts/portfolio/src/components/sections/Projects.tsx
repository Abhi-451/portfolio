            ...
            <div className="  h-full flex flex-col lg:flex-row  relative z-10">
              ...
              <div className="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                ...
                <div className="flex gap-4 mt-auto">
                  <a href="https://local-lance-api-server-uojw.vercel.app" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-6 py-3 bg-amber-600 hover:bg-cyan-500 text-white rounded-lg font-medium transition-colors">
