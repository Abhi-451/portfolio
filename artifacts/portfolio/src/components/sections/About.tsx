      ...
      >
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
            ...
            <div className="space-y-4 group">
              <div className="w-14 h-14 rounded-full bg-pink-500/10 flex items-center justify-center text-fuchsia-400 group-hover:scale-110 group-hover:bg-pink-500/20 transition-all duration-300">
